...
public class PostControllerTest {
    ...
    @Test
    @WithMockUser // 인증된 유저
    void Post_insert() throws Exception{
    ...
    @Test
    @WithAnonymousUser // 익명의 유저로 요청을 날릴 경우
    void Post_insert_login_error() throws Exception{
    ...
    @Test
    @WithAnonymousUser
    void Post_update_login_error() throws Exception{
    ...
    @Test
    @WithMockUser //포스트 수정시 본인글이 아닌 경우 에러 발생
    void Post_update_user_auth_error() throws Exception{
    ...
    @Test
    @WithMockUser //포스트 수정시 수정하려는 글이 없는 경우 에러발생
    void Post_update_post_not_error() throws Exception{
    ...
    @Test
    @WithAnonymousUser
    void 피드목록요청시_로그인_하지않은_경우() throws Exception {
        when(postService.list(any())).thenReturn(Page.empty());
    ...
    @Test
    @WithAnonymousUser
    void 내피드목록요청시_로그인_하지않은_경우() throws Exception {
        when(postService.my(any(), any())).thenReturn(Page.empty());
